...
<?php
 ...
 function enregistrer($MailUtilisateur,$NomUtilisateur, $PrenomUtilisateur, $AdresseUtilisateur, $CodePostalUtilisateur, $VilleUtilisateur, $PaysUtilisateur, $DateNaissanceUtilisateur, $TelephoneUtilisateur, $mdp){
    ...
    $req="INSERT INTO `Utilisateur` (`MailUtilisateur`, `NomUtilisateur`, `PrenomUtilisateur`, `AdresseUtilisateur`, `CodePostalUtilisateur`, `VilleUtilisateur`, `PaysUtilisateur`, `DateNaissanceUtilisateur`, `TelephoneUtilisateur`, `mdp`) 
